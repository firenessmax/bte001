...
"}"))
        ...
        self.label_8 = QtGui.QLabel(self.tab_exportar_3)
        self.label_8.setStyleSheet(_fromUtf8("margin-right:25px;"))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.horizontalLayout_7.addWidget(self.label_8)
        self.codigoLineEdit = QtGui.QLineEdit(self.tab_exportar_3)
        self.codigoLineEdit.setObjectName(_fromUtf8("codigoLineEdit"))
        self.horizontalLayout_7.addWidget(self.codigoLineEdit)
        self.verticalLayout_8.addLayout(self.horizontalLayout_7)
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.label_7 = QtGui.QLabel(self.tab_exportar_3)
        self.label_7.setIndent(3)
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.horizontalLayout_6.addWidget(self.label_7)
        self.centroLineEdit = QtGui.QLineEdit(self.tab_exportar_3)
        self.centroLineEdit.setObjectName(_fromUtf8("centroLineEdit"))
        self.horizontalLayout_6.addWidget(self.centroLineEdit)
        self.verticalLayout_8.addLayout(self.horizontalLayout_6)
        spacerItem1 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.verticalLayout_8.addItem(spacerItem1)
        self.gridLayout_6.addLayout(self.verticalLayout_8, 0, 10, 1, 1)
        ...
        self.label_6 = QtGui.QLabel(self.tab_exportar_3)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.horizontalLayout_4.addWidget(self.label_6)
        self.correlativoDoubleSpinBox = QtGui.QDoubleSpinBox(self.tab_exportar_3)
        self.correlativoDoubleSpinBox.setButtonSymbols(QtGui.QAbstractSpinBox.NoButtons)
        self.correlativoDoubleSpinBox.setDecimals(0)
        self.correlativoDoubleSpinBox.setMinimum(0.0)
        self.correlativoDoubleSpinBox.setMaximum(1999999999.0)
        self.correlativoDoubleSpinBox.setSingleStep(1.0)
        self.correlativoDoubleSpinBox.setProperty("value", 1.0)
        self.correlativoDoubleSpinBox.setObjectName(_fromUtf8("correlativoDoubleSpinBox"))
        self.horizontalLayout_4.addWidget(self.correlativoDoubleSpinBox)
        ...
        self.gridLayout_6.addItem(spacerItem2, 0, 12, 1, 1)
...
"}"))
        ...
        self.editarEmpresaToolButton = QtGui.QToolButton(self.frame_3)
        self.editarEmpresaToolButton.setObjectName(_fromUtf8("editarEmpresaToolButton"))
        self.horizontalLayout_3.addWidget(self.editarEmpresaToolButton)
        spacerItem5 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem5)
        self.deshacerToolButton = QtGui.QToolButton(self.frame_3)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/undo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deshacerToolButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/redo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rehacerToolButton.setIcon(icon6)
        ...
        self.toolButton_3.setMaximumSize(QtCore.QSize(0, 0))
        icon7 = QtGui.QIcon()
...
"}"))
        ...
        QtCore.QObject.connect(self.correlativoDoubleSpinBox, QtCore.SIGNAL(_fromUtf8("valueChanged(double)")), MainWindow.correlativo_changed_slot)
        QtCore.QObject.connect(self.editarEmpresaToolButton, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.config_slot)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "Código especial", None))
        self.label_7.setText(_translate("MainWindow", "Centro de resultados", None))
        ...
        self.label_6.setText(_translate("MainWindow", "Correlativo", None))
        ...
        self.editarEmpresaToolButton.setText(_translate("MainWindow", "Editar empresa", None))
        self.deshacerToolButton.setToolTip(_translate("MainWindow", "Deshace los cambios hechos al exportar Excel", None))
        self.deshacerToolButton.setText(_translate("MainWindow", "Deshacer", None))
        self.rehacerToolButton.setToolTip(_translate("MainWindow", "Volver a los valores de contabilizado originales", None))
