...
"}"))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/alerta.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.restaurarToolButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/pregunta.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.respaldarToolButton.setIcon(icon5)
...
"}"))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/Error.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/bigBug.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deshacerToolButton.setIcon(icon7)
