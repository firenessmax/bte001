...
"}"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/alerta.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "Marzo-2015", None))
