...
"}"))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/Error.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rehacerToolButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/bigBug.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Dispsitivo:", None))
